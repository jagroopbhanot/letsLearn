//package au.com.cuscal.domain.service;

//import au.com.cuscal.domain.service.session.enums.ErrorCodesEnum;
//import au.com.cuscal.domain.web.rest.errors.ErrorConstants;
//import au.com.cuscal.domain.web.rest.exception.BadRequestException;
...
public class Generate_Encrypted_Token_JWE {
...
//        String payload1 = "{\n" +
//            "  \"iss\": \"cdrbank.racq.com.au\",\n" +
//            "  \"aud\": \"consent-mgt-ui.cdrbank.racq.com.au\",\n" +
//            "  \"sub\": \"0000001616\",\n" +
//            "  \"exp\": 1633516782\n" +
//            "}";
...
//        String payload1 = "{\"iss\":\"cdrbank.racq.com.au\",\"aud\":\"consent-mgt-ui.cdrbank.racq.com.au\",\"sub\":\"0000001616\",\"exp\":1633516782}";
...
//                .audience("consent-mgt-ui.cdrbank.racq.com.au")
//                .subject("0000001616")
...
//        String tokenStr = decodeToken(token, null);
//
...
//            logger.info("Token String::{}", tokenStr);
       ...
       // Optional.ofNullable(tokenStr)
         //   .filter(value -> !(org.apache.commons.lang3.StringUtils.isBlank(value)))
         //   .orElseThrow(() ->
        //        new BadRequestException(ErrorConstants.INVALID_REQUEST_BODY, ErrorCodesEnum.INVALID_JWT));
        return tokenStr;
