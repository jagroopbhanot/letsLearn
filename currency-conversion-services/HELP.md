...
* The original package name 'jagroop.example.microservices.currency-conversion-services' is invalid and this project uses 'jagroop.example.microservices.currencyconversionservices' instead.
